...
export const HIGHLIGHTS: Highlight[] = [
	{
		...
		name: 'Groq',
		host: 'api.groq.com',
		why: 'The fastest tokens per second anyone gives away — GPT-OSS and Qwen 3.8 on LPU chips, no card.',
		stat: '1,000',
	...
	},
	{
		...
		why: 'The widest free catalogue anywhere: 82 open models, DeepSeek V4 and Nemotron included. Phone number, no card.',
		stat: '82',
